...
export class GuestRoomsService {
  ...
  getAvailableRoomsByHotelId(checkAvailabilityData: CheckAvailabilityData, hotel_id: number): Observable<any> {
    return this.http.get(`${this.apiUrl}/hotels/${hotel_id}/available-rooms`, { params: { ...checkAvailabilityData } });
  }
