...
export class BookingManagementService {
  ...
  manageBookingRequest(bookingId: number, decision: boolean): Observable<any> {
    return this.http.put(`${this.apiUrl}/${bookingId}/process`, { "action": decision ? "approve" : "reject" });
  }
