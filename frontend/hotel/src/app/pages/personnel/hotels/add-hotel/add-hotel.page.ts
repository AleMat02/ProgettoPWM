        ...
        this.hotelForm = this.fb.group(
            {
                ...
                latitude: ['', Validators.required, Validators.maxLength(15)], //Il fatto che alcuni campi debbano essere solo numeri viene controllato dall'ion-input nell'html tramite la proprietà "type"
